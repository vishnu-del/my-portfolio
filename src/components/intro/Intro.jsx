      ...
      <div className="container about__container">
        <div className="about__me">
          <div className="about__me-image">
            <img src="https://img.freepik.com/premium-photo/banner-tipe-full-stack-developer_980716-272.jpg?w=740" alt="developer" />
          </div>
        </div>
        <div className="about__content">
          ...
          <p>
            0.4 years experienced Front End Developer with hands-on experience in
